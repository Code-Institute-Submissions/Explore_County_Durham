...
var markers = [
    {
        ...
        lat: 54.8849314,
        lng: -1.6673812,
        header: '<h4 class="info-window-title">Beamish Museum</h4>',
        ...
        image: '<img src="assets/images/beamish_museum.jpg"',
    },
    {
        title: "Bowes Museum",
        lat: 54.5420335,
        lng: -1.9175423,
        header: '<h4 class="info-window-title">Bowes Museum</h4>',
        description:
        ...
        image: '<img src="assets/images/bowes_museum.jpg"',
    },
    {
        title: "Durham Cathedral",
        lat: 54.7732329,
        lng: -1.5785808,
        header: '<h4 class="info-window-title">Durham Cathedral</h4>',
        description:
        ...
        image: '<img src="assets/images/durham_cathedral_1.jpg"',
    },
    {
        title: "High Force Waterfall",
        lat: 54.6506813,
        lng: -2.1889541,
        header: '<h4 class="info-window-title">High Force Waterfall</h4>',
        description:
        ...
        image: '<img src="assets/images/high_force_waterfall.jpg"',
    },
    {
        title: "Diggerland Durham",
        lat: 54.8014524,
        lng: -1.6782121,
        header: '<h4 class="info-window-title">Diggerland Durham</h4>',
        ...
        image: '<img src="assets/images/digger_land.jpg"',
    },
    {
        title: "Raby Castle",
        lat: 54.5915822,
        lng: -1.8041618,
        header: '<h4 class="info-window-title">Raby Castle</h4>',
        ...
        image: '<img src="assets/images/raby_castle.jpg"',
    },
];

//Code taken from ASP Snippets.com, https://www.aspsnippets.com/Articles/Google-Maps-API-V3-Add-multiple-markers-with-InfoWindow-to-Google-Map.aspx//
  ...
  var markers = [
    ...
    { title: "High Force Waterfall", lat: 54.6506813, lng: -2.1889541, description: "High Force is one of the most impressive waterfalls in England. The River Tees has been plunging into this gorge for thousands of years but the rocks it reveals are far more ancient – with origins dating back over 300 million years!", image: '<img src="assets/images/high_force_waterfall.jpg"' },
    { title: "Diggerland Durham", lat: 54.8014524, lng: -1.6782121, description: "Diggerland is the UK’s most unique construction-themed adventure park where children and adults can drive, ride and operate earth-moving machinery in a safe and family friendly environment.", image: '<img src="assets/images/digger_land.jpg"' },
    { title: "Raby Castle", lat: 54.5915822, lng: -1.8041618, description: "Raby Castle offers a brilliant and memorable family day out. It is a jewell in the crown of County Durham and one of England's finest medieval castles.", image: '<img src="assets/images/raby_castle.jpg"' }
  ];
        ...
        for (var i = 0; i < markers.length; i++) {
            ...
            (function (marker, data) {
                google.maps.event.addListener(marker, "click", function (e) {
                    ...
                    infoWindow.setContent("<div style = 'width:300px;min-height:40px'>" + data.description + data.image + "</div>");

...
function loadMap() {
    ...
    for (var i = 0; i < markers.length; i++) {
        ...
        var newPlaceID = data.googlePlaceID;
        ...
        (function (marker, data) {
            google.maps.event.addListener(marker, "click", function () {
                ...
                let markerInfoHTML = `<div id='marker-info' class='container-fluid text-center'>
        ...
        service.getDetails({
            ...
            for (var i = 0; i < place.opening_hours.weekday_text.length; i++) {
                ...
                var openingHours = place.opening_hours.weekday_text[i]
